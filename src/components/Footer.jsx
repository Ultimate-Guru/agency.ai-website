        ...
        <motion.div
            ...
            <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
                ...
                <motion.div
                    ...
                    <img src={theme === 'dark' ? assets.logo_dark : assets.logo} alt="Logo" loading='lazy' className='w-32 sm:w-44' />
            ...
            <motion.div
                ...
                <p>Copyright 2025 &copy; Oluwatosin - All Right Reserved.</p>
                <div className='flex items-center justify-between gap-4'>
                    <img src={assets.facebook_icon} alt="Favebook-Icon" />
